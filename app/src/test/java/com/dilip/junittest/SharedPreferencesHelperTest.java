...
public class SharedPreferencesHelperTest {
    ...
    public void initMocks() {
        ...
        mSharedPreferenceEntry = new SharedPreferenceEntry(TEST_EMAIL);
    ...
    public void sharedPreferencesHelper_SaveAndReadPersonalInformation() {
        ...
        assertThat("Checking that SharedPreferenceEntry.email has been persisted and read "
                        + "correctly",
                mSharedPreferenceEntry.getmEmail(),
                is(equalTo(savedSharedPreferenceEntry.getmEmail())));
    }
    ...
    private SharedPreferencesHelper createMockSharedPreference() {
        ...
        when(mMockSharedPreferences.getString(eq(SharedPreferencesHelper.KEY_EMAIL),anyString()))
                .thenReturn(mSharedPreferenceEntry.getmEmail());
